...
def merge_multiplex(root_directory, text_to_match, splitkey):
    # obtain the list of all filepaths to merge
    paths = []
    ...
    out_match = "Union"
    print len(paths)
    paths = [path for path in paths if out_match not in path]
    print len(paths)
    # open gmls into graph objects and add edge-label
...
# congress: Senate
rd = "/Volumes/Durodon/clean_gmls/Social/Political/"
ttm = "*enate"
splitkey = "Senate"
merge_multiplex(rd,ttm,splitkey)
